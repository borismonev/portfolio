    ...
    return <div>
        <div className='hero-content'>
            <div className='hero-text'>
                ...
                <hr />
                <p className='subtitle'>
                    I love <b>experimenting with various devices</b>, seeing how they work, and experiencing the <b>innovative features</b> they bring to the world. I am studying <b>Information Technology</b> to enhance my understanding of technology on both a <b>hardware level</b> and <b>software level</b>.
                </p>
            </div>
            <img
                src={portraitImage}
        ...
        <div className='cards'>
            ...
            <Card
                title={'Projects'}
                content={'During my first year of university in the Netherlands I worked on team projects regarding an educational game and a visitor registration system for the research center next door.'}
                link={'/portfolio'}
            />
        </div>
    </div >
